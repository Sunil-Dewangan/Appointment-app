...
const Appointmentsuser = () => {
    ...
    const [newappointmodal, setNewappointmodal] = useState(false)
            ...
            >
                <Row className="justify_content_center">
                    ...
                    <Col xs={1} className="appointmodalhead"
                        onClick={() => { setNewappointmodal(false) }}
                ...
                <Row>
                                ...
                                <Col sm className="appointcentercols">
                                    ...
                                    <Row >
                                        <textarea type="Text" placeholder="Enter Purpose" height="200" className="createdeptmodalinput"
                ...
                <Col>
                    ...
                    <Row className="appointmentcard mt-2 ">
                        ...
                        <Row className="appointcenterhead mt-3">
                            ...
                            <Col className="justify_content_left">My Appointments</Col>
                            <Col className="justify_content_right">
                                <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Add New Appointment</Tooltip>}>
                                    <span className="d-inline-block">
                                        <button className="homgreqmsgbtn"
                                            onClick={() => { setNewappointmodal(true) }}
                                        >
                                            New Appointment
