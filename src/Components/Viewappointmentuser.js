                ...
                <Col>
                    ...
                    <Row className="appointmentcard mt-2 ">
                        ...
                        <Row className="appointcenterhead mt-3">
                            ...
                            <Col className="justify_content_left">Appointment</Col>
                        ...
                        {/* <Row>
                            ...
                            <Col sm={1} className="justify_content_center">
                            ...
                            <Col sm>
                                <Row className="">
                                    <Col xs={8}>
                                        ...
                                        <Row className="mt-3">
                                            <Col xs={3} className="homfeatureheading mx-2">Appointment Date:</Col>
                                            <Col className="homfeaturetext">30-03-2024</Col>
                                        </Row >
                                        <Row className="mt-3">
                                            <Col xs={3} className="homfeatureheading mx-2">Time Slot:</Col>
                                            <Col className="homfeaturetext">9am-9:30am</Col>
                                        </Row >
                                        <Row className="mt-3 ">
                                            <Col xs={3} className="homfeatureheading mx-2">Status</Col>
                                            <Col className="homfeaturetext">New appointment</Col>
                                        </Row >
                                        <Row className="mt-3 ">
                                            <Col xs={3} className="homfeatureheading mx-2">Puspose</Col>
                                            <Col className="homfeaturetext">"Sadak nirman"</Col>
                                        </Row >
                                        <Row className="mt-3 mb-5">
                                            <Col xs={3} className="homfeatureheading mx-2">No of persons</Col>
                                            <Col className="homfeaturetext">5</Col>
                                        </Row >
                                    </Col>
...
export default Viewappointmentuser